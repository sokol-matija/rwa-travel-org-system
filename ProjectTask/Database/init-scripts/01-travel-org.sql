-- Travel Organization System Database Initialization
-- This script creates the TravelOrganizationDB database and all tables with seed data

USE master;
GO

-- Create database if it doesn't exist
IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'TravelOrganizationDB')
BEGIN
...
PRINT 'TravelOrganizationDB created and initialized successfully!';
